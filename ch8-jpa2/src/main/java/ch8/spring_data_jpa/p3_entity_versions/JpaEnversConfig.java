...
@ComponentScan(basePackages = {"ch8.spring_data_jpa.p3_entity_versions"})
@EnableJpaRepositories(basePackages = "ch8.spring_data_jpa.p3_entity_versions.repository")
@EnableJpaAuditing(auditorAwareRef = "auditorAwareBean") // todo: used?
public class JpaEnversConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("ch8.spring_data_jpa.p3_entity_versions.entities");
