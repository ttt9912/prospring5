...
@ComponentScan(basePackages = {"ch8.p2_spring_data_jpa.simple_queries"})
@EnableJpaRepositories(basePackages = "ch8.p2_spring_data_jpa.simple_queries.repository") //scan for Repositories
