 ...
 */
class SelectSingersByFirstName extends MappingSqlQuery<Singer> {

    private static final String SQL_SELECT_BY_FIRSTNAME =
            "SELECT id, first_name, last_name, birth_date FROM singer " +
                    "WHERE first_name = :firstName";

    // create Query & set parameters
    SelectSingersByFirstName(final DataSource dataSource) {
        super(dataSource, SQL_SELECT_BY_FIRSTNAME);
